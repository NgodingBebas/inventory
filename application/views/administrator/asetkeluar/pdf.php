...
<h2>Laporan Transaksi Aset Keluar</h2>
';
                      ...
                      <section class="panel">
                          <table style="width:100%;border-collapse:collapse;" border="1">
                              ...
                              <tr>
                                  ...
                                  <th style="border:1px solid #999;padding:8px 0;background: #D8D8D8;">Kode Transaksi</th>
                                  <th style="border:1px solid #999;padding:8px 0;background: #D8D8D8;">Tanggal</th>
                            ...
                            $html .= '<tr>
                                          ...
                                          <td style="border:1px solid #999;padding:4px 8px;">'.$row->KODE_ASET_KELUAR.'</td>
                                          <td style="border:1px solid #999;padding:4px 8px;">'.$row->TANGGAL.'</td>
