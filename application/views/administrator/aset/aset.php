                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="btn-group">
                                  <a class="btn btn-primary" href="<?php echo base_url().'administrator/Data_Aset/Add_Jenis';?>" data-toggle="modal">
                                      Tambah Data <i class="fa fa-plus"></i>
                                  </a>
                                   
                              </div>
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="jenis">
                                      <thead>
                                      <tr>
                                          <th>ID Jenis</th>
                                          <th>Nama Jenis</th>
                                      ...
                                      <tr class="gradeX">
                                          ...
                                          <td><a href="<?php echo base_url().'administrator/Data_Aset/Edit_Jenis/';?><?php echo $row->KODE_JENIS; ?>">Edit</a></td>
                                          <td><a href="#Konfirm_Parameter_System_<?php echo $row->KODE_JENIS; ?>" data-toggle="modal">Hapus</a></td>
                                              <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="Konfirm_Parameter_System_<?php echo $row->KODE_JENIS; ?>" class="modal fade">
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">Hapus Jenis Aset <b><?php echo $row->NAMA_JENIS; ?></b> ?
                                                          </div>
                                                          <div class="modal-footer">
                                                              <button class="btn btn-info" data-dismiss="modal" onClick="Delete_Jenis(<?php echo $row->KODE_JENIS; ?>,'<?php echo base_url().'Administrator/Data_Aset/Delete_Jenis';?>')">Ya</button>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="btn-group">
                                  <a class="btn btn-primary" href="<?php echo base_url().'administrator/Data_Aset/Add_Aset';?>" data-toggle="modal">
                                      Tambah Data <i class="fa fa-plus"></i>
                                  </a>
                                  <a class="btn btn-success" href="<?php echo base_url().'administrator/Data_Aset/pdf';?>" data-toggle="modal">
